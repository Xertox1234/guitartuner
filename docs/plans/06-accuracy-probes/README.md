...
| **C** | the noise floor (CRLB) is ~100× below where we sit; the absolute floor is the sample clock | CRLB **0.021 ¢** single / **0.0011 ¢** harmonic-P10; **1 ¢ = 577.8 ppm**; 100 ppm = **0.17 ¢** |
