...
- Audio is processed entirely on-device and **never recorded, stored, or transmitted**. Do not add any persistence or network calls to the capture path. Canonical: `docs/rules/security.md`.
