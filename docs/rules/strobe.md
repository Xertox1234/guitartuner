...
- **Photosensitivity (WCAG 2.3.1):** the default off-pitch strobe was checked against WCAG 2.3.1 on 2026-06-19 — verdict **HAZARD** (full-screen, high-contrast, fixed-region flicker = N×beat-rate exceeds 3 Hz in the normal tuning range). Default-mode mitigation tracked in Task 4b. Analysis: `docs/solutions/accessibility/strobe-photosensitivity-2026-06-19.md`.
